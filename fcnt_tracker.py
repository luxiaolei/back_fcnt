...
def main(args):
	...
	tracker.params['particle_scales'] = [1,1]# [np.random.normal(1, 1e-3) for _ in range(10)]
	...
	for i in range(1349):
		#inputProducer.roi_params['roi_scale'] = norm_roi_scale_w * gt_last[2]
		i += 1
		if i % 30 == 0:
			print(len(gt_list))
		...
		gt_last = pre_loc
		gt_list += [pre_loc]
		print('pre: ', pre_loc[2:], 'actual: ', gt_cur[2:])
